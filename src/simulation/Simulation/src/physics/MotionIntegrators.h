...
namespace motion_integrators {
	inline void verlet(glm::vec3& position, glm::vec3& velocity, glm::vec3& acceleration, float delta)
	{
	...
	inline void forestRuth(glm::vec3& position, glm::vec3& velocity, glm::vec3& acceleration, float delta)
	{
